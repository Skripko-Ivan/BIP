...
def login(request: Request):
    if server.get_current_user() != "":
        print(f"not null {server.current_user}")
        return templates.TemplateResponse("home/index.html", {"request": request, "email": server.current_user})
